...
@Disabled
@Autonomous(name="Blue Far V1 Java The Hutts",group = "AAA")
public class A_BlueFarV1JavaTheHutts extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence leftTraj2 = drive.trajectorySequenceBuilder(leftTraj1.end())
                ...
                .addTemporalMarker(() -> {
                    // raise 4bar
                    freezeray.autonRaiseWeaponHeight(this,1100);
                })
                //go to backdrop
...
//                .build();
        ...
        TrajectorySequence rightTraj2 = drive.trajectorySequenceBuilder(rightTraj1.end())
                .setConstraints(SampleSwerveDrive.getVelocityConstraint(25, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleSwerveDrive.getAccelerationConstraint(15))
                .strafeTo(new Vector2d(-35.5, 38))
                .turn(Math.toRadians(180))
                .lineToLinearHeading(new Pose2d(-38, 35, Math.toRadians(180))) //38.5, 34
//                .turnTo(Math.toRadians(0))
//                //go to wall
//                .lineToLinearHeading(new Pose2d(-42, 58.5, Math.toRadians(0)))
//                //go past truss
